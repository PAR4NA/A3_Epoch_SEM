...
_hintString = "<t align='center' size='2.0' color='#f29420'>Missão<br/>C-130 Destruido</t><br/>
<t size='1.25' color='#ffff00'>______________<br/><br/>Um  avião com suprimentos caiu, bandido estão fazendo a proteção do local<br/>
