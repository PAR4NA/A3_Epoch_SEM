...
_hintString = "<t align='center' size='2.0' color='#f29420'>Missão<br/>Caminhão de Suprimentos</t><br/>
<t size='1.25' color='#ffff00'>______________<br/><br/>Um  caminhão com suprimentos quebrou, bandido estão fazendo a proteção do local!<br/>
Recupere os suprimento e mate todos os bandidos!";
...
if(_endCondition == 3)then[{ //Win!
	...
	_hintString = "<t align='center' size='2.0' color='#6bab3a'>Missão Feita com Sucesso<br/>
	<t size='1.25' color='#ffff00'>______________<br/><br/>Todos os Bandidos Eliminados!";
	SEM_globalHint = [_endCondition,_hintString]; publicVariable "SEM_globalHint";
},{	// 1 or 2 = Fail
	{deleteVehicle _x; sleep .1}forEach _missionObjects;
	_hintString = "<t align='center' size='2.0' color='#ab2121'>Missão FALHOU</t>";
	SEM_globalHint = [_endCondition,_hintString]; publicVariable "SEM_globalHint";
}];
